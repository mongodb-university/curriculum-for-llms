...
3. Talking head w/ sidebar
   - A database schema acts like a contract between data users
   - Migrations require coordination
4. Talking head w/ sidebar
   - MDB flexible document model allows frictionless migrations without downtime
5. Talking head w/ sidebar
   - Multiple schema versions can coexist in the same collection
   - Enable controlled migrations
6. Talking head w/ sidebar
   - Large number of versions increases complexity
   - Limit the number of schema versions
7. Talking head w/ sidebar
   - Schema versioning pattern
   - Schema validation
8. Talking head w/ slides
9. Talking head
...
16. Slides
17. Talking head
18. Talking head w/ icon
19. Talking head w/ sidebar
   - Schema Migration
   - Transitioning from one schema to the next
20. Talking head w/ sidebar
   - Schema Versioning pattern
   - Allow multiple valid schemas
   - Enable controlled migrations
21. Talking head w/ icon
22. Talking head w/ slides
23. Talking head
