---
title: "Video Script: Unit 5 Lesson 6 - Case-Sensitivity"
lesson_number: 8
...
1. Talking head w/ icons
2. Talking head w/ icons
3. Talking head w/ icon
4. Talking head
5. Talking head w/ slides
6. Talking head w/ slides
7. Talking head w/ sidebar
   - MongoDB queries are case-sensitive by default
8. Talking head w/ sidebar
   - **Case Sensitivity Anti-pattern**
   - Using default settings, expecting search terms to ignore case
   - Unexpected results
   - Reduced performance
9. Talking head w/ slides
10. Talking head w/ slides
11. Talking head
12. Talking head w/ sidebar
   - Option 1
   - Index and query have same case-insensitive collation
13. Talking head w/ sidebar
   - Option 2
   - Assign a default collation when we create a collection
   - Default collation applies to all indexes
   - Cannot be changed
   - Queries use same collation
14. Talking head w/ slides
15. Talking head w/ icon
16. Talking head w/ slides
17. Talking head w/ slides
18. Talking head
19. Talking head w/ slides
20. Talking head w/ slides
21. Talking head w/ slides
22. Talking head
23. Talking head w/ slides
24. Talking head w/ icon
25. Talking head w/ sidebar
   - Case Sensitivity Anti-Pattern
   - Unexpected query results
   - Improperly configured case insensitive queries and indexes
26. Talking head w/ sidebar
   - Case-insensitive queries must be supported by case-insensitive indexes
   - Queries and indexes must have same collation to provide case-insensitive results
   - Case-insensitive queries and indexes must have collation strength of 1 or 2
27. Talking head w/ sidebar
   - A default collation can be set when we create a collection
   - Ensures queries and indexes use the same collation to produce case-insensitive results
28. Talking head
